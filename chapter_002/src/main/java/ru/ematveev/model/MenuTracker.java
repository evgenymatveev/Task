...
public class MenuTracker {
    ...
    /**
     * Create List actions for storage the task.
     */
    private List<UserAction> actions;
    /**
     * Create List numbers for item menu.
     */
    ...
    public void fillAction() {
        this.actions.add(this.new AddItem("AddItem", 0));
        this.actions.add(this.new ShowItems("ShowItems", 1));
        this.actions.add(this.new UpdateItem("UpdateItem", 2));
        this.actions.add(this.new DeleteItem("DeleteItem", 3));
        this.actions.add(new FindByNameItem("FindByNameItem", 4));
        this.actions.add(new FindByIdItem("FindByIdItem", 5));
        this.actions.add(new DeleteAllItem("DeleteAllItem", 6));
        this.actions.add(new AddCommentForItem("AddCommentForItem", 7));
    }

    /**
     * Method for create the array.
     * @return List number for menu;
     */
    public List<Integer> numberItems() {
    ...
    public void select(int key) {
        this.actions.get(key).execute(this.input, this.tracker, this.printer);
    }
